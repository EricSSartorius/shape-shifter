...
import { BACKSPACE, DEFAULT_ELEMENT_COLOR, SCREEN_HEIGHT, SCREEN_WIDTH } from "../constants"
...
export function DynamicElement({ element }: Props) {
  ...
  const { setSelectedElement, updateElement, selectedElement, removeElement, elements } = useElement()
  ...
  return (
    <>
      <ElementDiv ref={targetRef} $isSelected={isSelected} onClick={highlightElement} onMouseDown={highlightElement} />
      <Moveable
        flushSync={flushSync}
        target={targetRef}
